...
exports.convertWeight = exports.MassConverter = void 0;
exports.convertMass = convertMass;
exports.roundMass = roundMass;
 ...
 */
function roundMass(value, decimals = 4) {
...
exports.MassConverter = {
     ...
     */
    poundsToKilograms: (pounds) => convertMass(pounds, 'lb', 'kg'),
    /**
     ...
     */
    kilogramsToPounds: (kg) => convertMass(kg, 'kg', 'lb'),
    /**
     ...
     */
    ouncesToGrams: (oz) => convertMass(oz, 'oz', 'g'),
    /**
     ...
     */
    gramsToOunces: (grams) => convertMass(grams, 'g', 'oz'),
    /**
     * Converts metric tons to US tons.
     * @param {number} metricTon - The mass in metric tons.
     * @returns {number} The mass in US tons.
     */
    metricToUSTon: (metricTon) => convertMass(metricTon, 'ton', 'us-ton'),
    /**
     * Converts metric tons to UK tons.
     * @param {number} metricTon - The mass in metric tons.
     * @returns {number} The mass in UK tons.
     */
    metricToUKTon: (metricTon) => convertMass(metricTon, 'ton', 'uk-ton'),
};
exports.convertWeight = convertMass;
